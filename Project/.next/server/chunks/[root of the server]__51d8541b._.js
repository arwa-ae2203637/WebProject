...
"[project]/.next-internal/server/app/users/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/repo/models/administrator.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$repo$2f$models$2f$administrator$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/repo/models/administrator.js [app-route] (ecmascript)");
;
;
;
;
    ...
    try {
        ...
        return parsedUsers.map((user)=>{
            switch(user.userType){
                ...
                case "admin":
                    return __TURBOPACK__imported__module__$5b$project$5d2f$repo$2f$models$2f$administrator$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Admin"].fromJSON(user);
            }
        });
    } catch (e) {
...
async function create(body) {
    ...
    switch(body.userType){
        ...
        case "instructor":
            ...
            break;
        case "admin":
            user = __TURBOPACK__imported__module__$5b$project$5d2f$repo$2f$models$2f$administrator$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Admin"].fromJSON(user);
            break;
    }
    console.log(user);
    users.push(user);
...
"[project]/app/users/[id]/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(reuqest, { params }) {
    try {
        ...
        try {
            const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$repo$2f$users$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["read"])(id);
...
async function PUT(request, { params }) {
    try {
        ...
        const updated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$repo$2f$users$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["update"])(id, body);
        console.log(updated);
...
async function DELETE(request, { params }) {
    try {
        const { id } = await params;
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$repo$2f$users$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["remove"])(id);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__51d8541b._.js.map
...
"[project]/.next-internal/server/app/courses/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/courses/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const courses = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$repo$2f$courses$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["read"])();
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(courses.map((course)=>course.toJSON()), {
            status: 200
        });
    } catch (e) {
        console.error(e);
...
async function POST(request, { params }) {
    try {
        ...
        try {
            course = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$repo$2f$courses$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["create"])(course);
        } catch (e) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: "Conflict"
            }, {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__a1fb703f._.js.map